        ...
        return (
          <section className="panel p-5">
            ...
            <dl className="mt-5 grid gap-3 md:grid-cols-2">
              ...
              <SignatureField label="Documento" value="Solicitud inicial · versión v1.2" />
            ...
            <label className="mt-5 flex gap-3 rounded-lg border border-line bg-paper p-4 text-sm leading-6 text-ink">
              ...
              />
              <span>
                Declaro que he revisado el contenido del documento y presto conformidad para firmarlo electrónicamente.
              </span>
            </label>
            ...
            {signed ? (
              <div className="mt-5 rounded-lg border border-[#b8dcc7] bg-[#edf8f1] p-4 text-sm leading-6 text-ok">
                Firma registrada con código FIR-PPS0-CME-2026-42. El evento quedó agregado al historial de auditoría del expediente.
              </div>
            ) : null}
          </section>
        );
